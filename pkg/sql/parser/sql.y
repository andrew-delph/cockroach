...
| ALTER opt_column column_name alter_column_on_update
  ...
  // ALTER TABLE <name> ALTER [COLUMN] <colname> SET {VISIBLE|NOT VISIBLE} // DO similair to this...
...
| ALTER opt_column column_name set_generated_always
  {
    ...
    // return setErr(sqllex, errors.New("testyyyw"))
  }  // andrew 
...
alter_column_sequence_option_elem:
  ...
  | SET RESTART                      { return setErr(sqllex, errors.New("sequence option \"restart\" not supported here")) }                                  
