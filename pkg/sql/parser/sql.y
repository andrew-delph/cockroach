...
//   ALTER TABLE ... ALTER [COLUMN] <colname> SET GENERATED ALWAYS
//   ALTER TABLE ... ALTER [COLUMN] <colname> SET GENERATED BY DEFAULT
//   ALTER TABLE ... ALTER [COLUMN] <colname> {SET <sequence_option> | RESTART [ [ WITH ] restart ]}
